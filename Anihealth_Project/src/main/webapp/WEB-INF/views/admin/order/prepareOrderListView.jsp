    ...
    <div class="mypage-panel-container-my">
		        			...
		        			<c:choose>
					        	...
					        	<c:otherwise>
				        			<form id="postForm" action="" method="post"> 
				        				...
				        				<input type="hidden" name="deliveryStatus" value="배송준비중">
				        			
						        		<c:forEach var="o" items="${ requestScope.list }">
						        			<tr class="listTr">
						        				<td>
						        					<input type="checkbox" name="orderNos" value="${ o.orderNo }">
						        				</td>
						        				<td class="click">${ o.orderNo }</td>
						        				<td class="click">${ o.orderDate }</td>
						        				<td class="click">${ o.userId }</td>
						        				<td class="click">${ o.deliveryStatus }</td>
						        				<td class="click">
        ...
        <script>
	       ...
	       $(function() {
			 ...
			 $("#list-area>tbody>tr>.click").click(function() {
					
				let orderNo = $(this).parent(".listTr").children().eq(1).text();
